        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/pizza.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>119, Galle Rd, Colombo 7</p>
                                    <h5>Phone: +94 765677852</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>We provide healthy and quality foods for you.</p>
                                </div>
                            </div>
                        </div>
                    </div>
